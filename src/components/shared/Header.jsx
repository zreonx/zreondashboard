...
const Header = () => {
  ...
  return (
    <div className="bg-white h-16 px-4 flex justify-between items-center border-b border-gray-200 sticky top-0 z-[1000]">
        ...
        <Menu as="div" className="relative">
          <div>
            <Menu.Button className="ml-2 inline-flex rounded-full focus:outline-none focus:ring-2 focus:ring-neutral-400">
              ...
              >
                <span className="sr-only">Zreon Dev</span>
              </div>
            </Menu.Button>
          </div>
          <Transition
              ...
              <Menu.Item>
                {({ active }) => (
                  <div
                    className={classNames(
                      active && "bg-gray-100",
                      "text-gray-700 focus:bg-gray-200 cursor-pointer rounded-sm round-sm px-4 py-2"
                    )}
                    onClick={() => {
                      navigate("/profile");
                    }}
